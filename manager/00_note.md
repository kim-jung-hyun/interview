...
## 1.1 Framework Architecture & Policy-as-Code (3~4분) <- 특허 및 데모가 산출물 이다 
...
**피할 말**  "한 파이프라인의 baseline을 코드로 정의한 사례" ○

---

## 1.2 Assurance Partnering (3~4분) - 현재 작성하고 있는 논문 이 기술 적인 내용은 THCH 에서 정리 하고 지금은 살툴
**산출물②** (Assurance용 구조 요건) 기반으로 이건 
> **그리고 Assurance가 확인하는 기준이 AI GRC 기준 하나만은 아닙니다.** 신뢰성·성능 같은 다른 기준도 같이 봅니다. **제 역할은 그중 AI GRC 기준이 검증 가능한 형태로 정의되고, 검증팀이 그것을 확인할 수 있도록 지원하는 것**입니다." 로 짦게 이야기 하는게 좋겠다. 
...
그러므로 개발시 어떤 기능 이나 LOG에 어떤 내용이 필요 한지 ASSURANCE 팀과 정의가 필요 합니다. 
---
