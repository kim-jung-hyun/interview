...
- **1차로 Security Architecture 팀에**, 이어서 개발팀에 규제·위험 요구사항을 SW 구조에 반영할 수 있는 기준과 가이드를 제공한다.
...
2. Policy intent를 유지한 채 구현을 교체하거나 튜닝할 수 있는가?

> 동일한 policy intent 안에서 교체·튜닝할 수 있다면 Guardrail에 가깝다.
